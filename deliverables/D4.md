...
1. Visual Studio Code - Used to write the Javascript, HTML, and CSS, also has good compatibility with Git for version control.
2. MongoDB - Used for data base storage and API to access it.
3. React - Used for client server communication for the website, and for modularization of the HTML/CSS
